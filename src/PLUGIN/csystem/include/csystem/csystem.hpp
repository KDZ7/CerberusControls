...
namespace csystem
{
  ...
  private:
    ...
    rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr movetime_sub_;
    ...
    hardware_interface::LoanedStateInterface *movetime_state_interface_;
    ...
    hardware_interface::LoanedCommandInterface *movetime_command_interface_;
