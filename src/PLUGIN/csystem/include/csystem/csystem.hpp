...
namespace csystem
{
  ...
  private:
    ...
    std::unique_ptr<realtime_tools::RealtimePublisher<std_msgs::msg::Float64>> rt_movetime_pub_;
    std::shared_ptr<rclcpp::Subscription<std_msgs::msg::Float64>> movetime_sub_;
    ...
    realtime_tools::RealtimeBuffer<double> rt_movetime_buffer_;
    ...
    hardware_interface::LoanedStateInterface *movetime_state_interfaces_;
    ...
    hardware_interface::LoanedCommandInterface *movetime_command_interfaces_;
