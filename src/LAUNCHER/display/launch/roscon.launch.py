...
def generate_launch_description():
    ...
    transistion_iksolver = ExecuteProcess(
        cmd=["sleep 5 && ros2 lifecycle set /iksolver configure && sleep 5 && ros2 lifecycle set /iksolver activate"],
        shell=True
    )
    ...
    transistion_gmotion = ExecuteProcess(
        cmd=["sleep 5 && ros2 lifecycle set /gmotion configure && sleep 5 && ros2 lifecycle set /gmotion activate"],
        shell=True
    )
    # zmp_stabilizer = Node(
