...
def generate_launch_description():
    ...
    event_handler = [
        ...
        RegisterEventHandler(OnProcessStart(target_action=joint_state_broadcaster_spawner, on_start=[TimerAction(period=5.0, actions=[csystem_controller_spawner ])])),
        RegisterEventHandler(OnProcessStart(target_action=csystem_controller_spawner, on_start=[TimerAction(period=5.0, actions=[joint_group_positon_controller_spawner])])),
        RegisterEventHandler(OnProcessStart(target_action=joint_group_positon_controller_spawner, on_start=[TimerAction(period=5.0, actions=[rqt_controller_manager])])),
    ]
